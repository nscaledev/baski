	...
	tc := []struct {
		...
		},
		{
			...
			expected: GlobalBuildConfig{
				...
				KubernetesDebVersion: "1.28.2-1.1",
				NodeCustomRolesPre:   "security",
				AnsibleUserVars:      "install_falco=true install_trivy=true",
				ExtraDebs:            "nfs-common",
			},
		},
		{
		...
		},
		{
			...
			expected: GlobalBuildConfig{
				...
				KubernetesDebVersion: "1.28.2-1.1",
				NodeCustomRolesPre:   "security",
				AnsibleUserVars:      "load_additional_components=true additional_registry_images=true additional_registry_images_list=image1,image2 install_falco=true install_trivy=true",
				ExtraDebs:            "nfs-common",
			},
		},
		{
		...
		},
		{
			...
			expected: GlobalBuildConfig{
				...
				AnsibleUserVars:      "gpu_vendor=amd amd_version=6.0.2 amd_deb_version=6.0.60002-1 gpu_amd_usecase=dkms install_falco=true install_trivy=true",
				ExtraDebs:            "nfs-common",
			},
		},
		{
			...
			expected: GlobalBuildConfig{
				...
				KubernetesDebVersion: "1.28.2-1.1",
				NodeCustomRolesPre:   "gpu security",
				AnsibleUserVars:      "gpu_vendor=amd amd_version=6.0.2 amd_deb_version=6.0.60002-1 gpu_amd_usecase=dkms load_additional_components=true additional_registry_images=true additional_registry_images_list=image1,image2 install_falco=true install_trivy=true",
				ExtraDebs:            "nfs-common",
			},
		},
		{
...
func TestGenerateVariablesFile(t *testing.T) {
	tc := []struct {
		...
		},
		{
			...
			expected: `{"kubernetes_cni_semver":"v1.2.0","kubernetes_cni_deb_version":"1.2.0-2.1","crictl_version":"1.26.0","kubernetes_semver":"v1.28.2","kubernetes_rpm_version":"1.28.2","kubernetes_series":"v1.28","kubernetes_deb_version":"1.28.2-1.1","node_custom_roles_pre":"security","ansible_user_vars":"install_falco=true","extra_debs":"nfs-common","source_image":"","networks":"","flavor":"","image_disk_format":"","volume_type":"","volume_size":"","qemu_binary":"","disk_size":"","output_directory":""}`,
		},
		{
			name: "Test config with Trivy",
			conf: GlobalBuildConfig{
			...
			expected: `{"kubernetes_cni_semver":"v1.2.0","kubernetes_cni_deb_version":"1.2.0-2.1","crictl_version":"1.26.0","kubernetes_semver":"v1.28.2","kubernetes_rpm_version":"1.28.2","kubernetes_series":"v1.28","kubernetes_deb_version":"1.28.2-1.1","node_custom_roles_pre":"security","ansible_user_vars":"install_trivy=true","extra_debs":"nfs-common","source_image":"","networks":"","flavor":"","image_disk_format":"","volume_type":"","volume_size":"","qemu_binary":"","disk_size":"","output_directory":""}`,
		},
		{
			name: "Test config with Falco & trivy",
			conf: GlobalBuildConfig{
			...
			expected: `{"kubernetes_cni_semver":"v1.2.0","kubernetes_cni_deb_version":"1.2.0-2.1","crictl_version":"1.26.0","kubernetes_semver":"v1.28.2","kubernetes_rpm_version":"1.28.2","kubernetes_series":"v1.28","kubernetes_deb_version":"1.28.2-1.1","node_custom_roles_pre":"security","ansible_user_vars":"install_falco=true install_trivy=true","extra_debs":"nfs-common","source_image":"","networks":"","flavor":"","image_disk_format":"","volume_type":"","volume_size":"","qemu_binary":"","disk_size":"","output_directory":""}`,
		},
		{
			name: "Test config with additional images",
			conf: GlobalBuildConfig{
